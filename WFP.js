...
var Fonts = function() {
    ...
    protocol = window.location.protocol === "https:" ? "https:" : "http:", apiKey = "AIzaSyAiarVBOlH5jvLpBNHUN-WSIbkkxrWB7zM", listAPI = "https://www.googleapis.com/webfonts/v1/webfonts", fontsAPI = protocol + "//fonts.googleapis.com/css?family=", letter = /[a-zA-Z]/, list = {}, // Object of <family name>:<fontObj> available.
